...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp1(XLua.LuaTable p0, LuaItem p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(ItemInitDele))
			{
			    return new ItemInitDele(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(ItemInitDeleObj))
			{
			    return new ItemInitDeleObj(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(System.Action<XLua.LuaTable, bool>))
			{
			    return new System.Action<XLua.LuaTable, bool>(__Gen_Delegate_Imp2);
			}

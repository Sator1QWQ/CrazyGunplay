...
namespace XLua.CSObjectWrap
{
    public class Config_SkillExpressionBridge : LuaBase, Config_SkillExpression
    {
        ...
        SkillExpressionPlayTiming Config_SkillExpression.playTiming 
        {
            ...
            get 
            {
                ...
                lock (luaEnv.luaEnvLock)
                {
					...
					LuaAPI.lua_getref(L, luaReference);
					LuaAPI.xlua_pushasciistring(L, "playTiming");
					if (0 != LuaAPI.xlua_pgettable(L, -2))
					{
						luaEnv.ThrowExceptionFromError(oldTop);
					}
					SkillExpressionPlayTiming __gen_ret;translator.Get(L, -1, out __gen_ret);
					LuaAPI.lua_pop(L, 2);
					return __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
                }

...
namespace XLua.CSObjectWrap
{
    public class Config_SkillExpressionBridge : LuaBase, Config_SkillExpression
    {
        ...
        string Config_SkillExpression.animationPath 
        {
            ...
            get 
            {
                ...
                lock (luaEnv.luaEnvLock)
                {
					...
					LuaAPI.lua_getref(L, luaReference);
					LuaAPI.xlua_pushasciistring(L, "animationPath");
					if (0 != LuaAPI.xlua_pgettable(L, -2))
					{
						luaEnv.ThrowExceptionFromError(oldTop);
					}
        ...
        string Config_SkillExpression.effectPath 
        {
        ...
        bool Config_SkillExpression.isEffectFollow 
        {
        ...
        System.Collections.Generic.List<float> Config_SkillExpression.effectScale 
        {
            ...
            get 
            {
                ...
                lock (luaEnv.luaEnvLock)
                {
					...
					LuaAPI.lua_getref(L, luaReference);
					LuaAPI.xlua_pushasciistring(L, "effectScale");
					if (0 != LuaAPI.xlua_pgettable(L, -2))
					{
						luaEnv.ThrowExceptionFromError(oldTop);
					}
        ...
        SkillEffectDeleteTiming Config_SkillExpression.effectDeleteTiming 
        {

...
namespace XLua.CSObjectWrap
{
    ...
    public class SceneToolWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(SceneTool);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SceneTool constructor!");
        ...
        static int _m_ChangeScene_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    SceneTool.ChangeScene( _sceneId );

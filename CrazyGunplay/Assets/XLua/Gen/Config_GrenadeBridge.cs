...
{
    public class Config_GrenadeBridge : LuaBase, Config_Grenade
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new Config_GrenadeBridge(reference, luaenv);
		}
		
		public Config_GrenadeBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
        ...
        bool Config_Grenade.isSkill 
        {
            ...
            get 
            {
                ...
                lock (luaEnv.luaEnvLock)
                {
					...
					LuaAPI.lua_getref(L, luaReference);
					LuaAPI.xlua_pushasciistring(L, "isSkill");
					if (0 != LuaAPI.xlua_pgettable(L, -2))
					{
						luaEnv.ThrowExceptionFromError(oldTop);
					}
        ...
        float Config_Grenade.delay 
        {
            ...
            get 
            {
                ...
                lock (luaEnv.luaEnvLock)
                {
					...
					LuaAPI.lua_getref(L, luaReference);
					LuaAPI.xlua_pushasciistring(L, "delay");
					if (0 != LuaAPI.xlua_pgettable(L, -2))
					{
						luaEnv.ThrowExceptionFromError(oldTop);
					}
        ...
        string Config_Grenade.effectPath 
        {
